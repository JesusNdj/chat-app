...
const autoScroll = () => {
  ...
  if (containerHeight - newMessageHeight <= scrollOffset) {
    $messages.scrollTop = $messages.scrollHeight; // If we always scroll down, just use this line.
  }
};
...
$buttonSendLocation.addEventListener("click", (event) => {
  if (!navigator.geolocation) {
    return alert("Geolocation is not sopported by your browser");
  }
